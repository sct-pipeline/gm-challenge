#!/usr/bin/env python
#
# Process data by batch within folders. This script will look for csv files, which are generated by simu_create_phantom.py,
...
#   ${SCT_DIR}/python/bin/python ${PATH_GMCHALLENGE}simu_process_data.py -i folder1 folder2 -s folder1/mask_cord.nii.gz -g folder1/mask_gm.nii.gz -r 0
#
# OUTPUT:
